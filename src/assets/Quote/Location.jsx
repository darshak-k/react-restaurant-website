      ...
      <div className="flex flex-col justify-between min-h-[100vh]">
        <div>
          <div className="flex justify-center my-10">
            <Link to="/Quotes">
              <div className="rounded-full mx-5 bg-[#fea700] hover:opacity-100 opacity-40 md:w-[100px] w-[80px]  md:h-[100px] h-[80px] p-2 ">
            ...
            <Link to="/Quotstwostep">
              <div className="rounded-full mx-5 bg-[#57b464] hover:opacity-100  opacity-40 md:w-[100px] w-[80px]  md:h-[100px] h-[80px] p-2 ">
                <div className="rounded-full h-[100%] w-[100%] border-white border-[2px] ">
                  <div className=" flex flex-col justify-center items-center h-[100%]">
                    <h3 className="font-itim text-white md:text-[45px] text-[25px]">
                      2
